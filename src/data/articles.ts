...
export const articles: Article[] = [
  {
    id: '1',
    title: 'React 18 并发特性深入解析',
    summary: '深入理解 React 18 的 Concurrent Mode、useTransition、useDeferredValue 等并发特性，以及它们如何改善用户体验。',
    content: `## 什么是并发渲染？
...
并发特性为 React 应用带来了更流畅的用户体验，但需要理解其工作原理才能正确使用。`,
    category: '前端',
  ...
  },
  {
    ...
    summary: '从条件类型到模板字面量类型，全面解析 TypeScript 类型系统的高级用法与实际应用场景。',
...
高级类型应该服务于代码的可维护性和类型安全，而不是为了炫技。`,
  ...
  },
  {
    ...
    summary: '基于 Node.js + Express + Docker 搭建微服务体系，涵盖服务发现、负载均衡、消息队列等核心模块。',
    content: `## 微服务架构概述
...
微服务架构提升了系统的可扩展性和可维护性，但也带来了分布式系统的复杂性。`,
    category: '后端',
  ...
  },
  {
    ...
    summary: '告别 Media Query 的局限，用 Container Queries 实现真正基于组件的响应式设计。',
    content: `## 引言
...
2025 年所有主流浏览器都已支持 Container Queries，可以放心在生产环境使用。`,
    category: '前端',
    tags: ['CSS', '响应式'],
  ...
  },
  {
    id: '5',
    title: 'Git 工作流最佳实践',
    summary: '团队协作中的 Git 分支策略、提交规范与 Code Review 流程，提升开发效率与代码质量。',
    content: `## Git 分支策略
...
- **Stash**: 暂存未完成的修改`,
  ...
  {
    id: '6',
    title: 'Webpack 到 Vite：构建工具迁移实战',
    summary: '从 Webpack 迁移到 Vite 的完整过程，包含配置对比、插件替换与性能对比数据。',
    content: `## 为什么选择 Vite
...
- 部分 Webpack 特有 Loader 需要找 Vite 插件替代`,
    category: '工具',
    tags: ['Vite', 'Webpack', '构建工具', '性能优化'],
  ...
  },
  {
    id: '7',
    title: '从零搭建个人技术博客',
    summary: '分享独立开发技术博客的全过程：技术选型、架构设计、部署上线与内容管理。',
    content: `## 为什么要自己搭建博客
...
搭建个人博客不只是为了展示内容，更是一个完整的软件工程实践过程。`,
    category: '随笔',
    tags: ['博客', 'React', '全栈'],
    coverImage: 'https://picsum.photos/seed/blog/800/400',
    author: '张三',
  ...
  },
  {
    ...
    summary: '从 URL 设计到错误处理，全面解析 RESTful API 的设计原则与常见模式。',
    content: `## REST 架构风格
...
推荐使用 URL 路径版本，最为直观：\`/api/v1/articles\``,
    category: '后端',
    tags: ['API', 'RESTful', '架构设计'],
  ...
  },
  {
    id: '9',
    title: '前端性能优化全景指南',
    summary: '从网络层到渲染层，系统梳理前端性能优化的各种策略与工具，附 Lighthouse 实战调优案例。',
    content: `## 性能优化金字塔
...
2. 图片懒加载减少初始请求
3. CSS 变量替代运行时主题计算
4. 合理使用 useMemo / useCallback`,
    category: '前端',
    tags: ['性能优化', 'Lighthouse', 'React'],
    coverImage: 'https://picsum.photos/seed/perf/800/400',
    author: '张三',
  ...
  },
  {
    ...
    summary: '通过多阶段构建、合理选择基础镜像和 .dockerignore 等手段，将镜像体积从 1.2GB 缩减至 120MB。',
    content: `## 问题背景
...
多阶段构建是 Docker 镜像优化的核心手段，配合 Alpine 基础镜像和合理的层设计，可以显著减小镜像体积。`,
    category: '后端',
    tags: ['Docker', 'DevOps', '性能优化'],
